...
{
    public partial class traansaction_form : Form
    {
        public traansaction_form()
        {
            InitializeComponent();
        }
        ...
        {
            UpdatetrasnactionCountLabel();
        }

        private void button1_Click(object sender, EventArgs e)
        {
            // Create an instance of the warehouse_dashboard form
            warehouse_dashboard transactionform = new warehouse_dashboard();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                form.Text = "Enter Transaction Details";
                form.Width = 400;
                form.Height = 250;

                // Labels
                var transactionIdLabel = new Label();
                transactionIdLabel.Text = "Transaction ID:";
                transactionIdLabel.Location = new System.Drawing.Point(10, 10);
                form.Controls.Add(transactionIdLabel);
                ...
                amountlabel.Location = new System.Drawing.Point(10, 70);
                form.Controls.Add(amountlabel);


                var purchaselabel = new Label();
                purchaselabel.Text = "Purchase Quantity:";
                purchaselabel.Location = new System.Drawing.Point(10, 100);
                form.Controls.Add(purchaselabel);



                // Textboxes
                var transactionIdTextBox = new TextBox();
                transactionIdTextBox.Location = new System.Drawing.Point(120, 10);
                form.Controls.Add(transactionIdTextBox);
                ...
                amountTextBox.Location = new System.Drawing.Point(120, 70);
                form.Controls.Add(amountTextBox);



                var purchaseTextBox = new TextBox();
                purchaseTextBox.Location = new System.Drawing.Point(120, 100);
                ...
                submitButton.Click += (s, ev) =>
                {
                    ...
                    string insertQuery = $"INSERT INTO Transac (transaction_id, purchase_quantity,product_id,amount) " +
                    $"VALUES ('{transactionId}', '{purchase}','{productId}','{amount}')";
            ...
            try
            {
                ...
                dataGridView.CellContentClick += (s, ev) =>
                {
                    if (dataGridView.Columns[ev.ColumnIndex] is DataGridViewButtonColumn && ev.RowIndex >= 0)
                    {
                        ...
                        int transactionIdToDelete = (int)dataGridView.Rows[ev.RowIndex].Cells["transaction_id"].Value;
                        ...
                        try
                        {
                            ...
                            {
                                connection.Open();
                                string deleteQuery = $"DELETE FROM Transac WHERE transaction_id = {transactionIdToDelete}";
        ...
        private void UpdatetrasnactionCountLabel()
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                label3.Text = "Transaction " + transactioncount.ToString();
            }
        }
